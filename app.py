...
def ui_simulation_parameters(data: Dict[str, Any]) -> None:
    ...
    with st.expander("Simulation Parameters"):  
        ...
        data["simulation_parameters"]["time_step"] = st.number_input(
            "Time Step:", data["simulation_parameters"]["time_step"]
        )
...
if __name__ == "__main__":
    ...
    with tab1:
        ...
        data = st.session_state.data.get("loaded_data", {})
        ...
        if c1.button(
            ...
            st.session_state.button_clicks["load_config"] = True
        ...
        if c2.button(
            ...
            st.session_state.button_clicks["save_config"] = True
    ...
    with tab2:
        ...
        if st.button("Run Simulation"):
            ...
            st.session_state.button_clicks["run_simulation"] = True
